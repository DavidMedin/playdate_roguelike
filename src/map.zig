...
const BLOCK_SIZE = 16;
const Rect = struct { x: i32, y: i32, w: i32 = BLOCK_SIZE, h: i32 = BLOCK_SIZE };

pub fn get_entities_here(ctx: *context.Context, position: transform.Vector(i32)) !?std.ArrayList(ecs.Entity) {
